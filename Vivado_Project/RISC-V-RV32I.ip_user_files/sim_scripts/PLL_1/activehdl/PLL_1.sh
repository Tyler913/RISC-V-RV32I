...
#                script (type 'PLL_1.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/TylerHong/Development/GitHub_Project/FPGA/RISC-V-RV32I/Vivado_Project/RISC-V-RV32I.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
