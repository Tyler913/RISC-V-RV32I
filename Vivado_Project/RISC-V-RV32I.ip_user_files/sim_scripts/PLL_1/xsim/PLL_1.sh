...
#
# Script generated by Vivado on Sat Nov 01 01:25:45 +0800 2025
...
#
# Usage        : PLL_1.sh
#                PLL_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                PLL_1.sh [-reset_run]
#                PLL_1.sh [-reset_log]
#                PLL_1.sh [-help]
#
...
export RDI_DATADIR="D:/Applications/Vivado_2025.1.1/2025.1.1/Vivado/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "PLL_1.sh - Script generated by export_simulation (Vivado v2025.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./PLL_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PLL_1 xil_defaultlib.PLL_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim PLL_1 -key {Behavioral:sim_1:Functional:PLL_1} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Applications/Vivado_2025.1.1/2025.1.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PLL_1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./PLL_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: PLL_1.sh [-help]\n\
Usage: PLL_1.sh [-step]\n\
Usage: PLL_1.sh [-lib_map_path]\n\
Usage: PLL_1.sh [-reset_run]\n\
Usage: PLL_1.sh [-reset_log]\n\
Usage: PLL_1.sh [-keep_index]\n\
Usage: PLL_1.sh [-noclean_files]\n\n\
